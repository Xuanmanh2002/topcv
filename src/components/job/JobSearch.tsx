...
import { searchJobs, getAllAddress, getAllCategory } from '../utils/ApiFunctions';
    ...
    useEffect(() => {
        const fetchJobs = async () => {
            if (keyword) {
                setLoading(true);
                try {
                    const fetchedJobs = await searchJobs(keyword);
                    setJobs(fetchedJobs);
                } catch (error) {
                    ...
                    <div className='job-search-container'>
                        <div className='job-search-navbar'>
                            <div className='job-search-navbar-title'>
                                <h1 className='job-search-navbar-heading'>Tuyển dụng việc làm {keyword} </h1>
                                <div className='job-search-navbar-link'>
                                    <ul className='job-search-navbar-item'>
                                        ...
                                        <FaChevronRight className='job-search-icon-right' />
                                        <p className='job-search-icon-describe' style={{ paddingLeft: "10px" }} >{keyword}</p>
                                    </ul>
                                </div>
                            </div>
